<form class="sb_detail-header__search-form"  method="GET" action="search" enctype="multipart/form-data" onsubmit="return q.value!={{constant::$emptyString}}">
    ...
    <div class="sb_detail-header__catagories-container">
        ...
        <span id="catagory_news" ><a href="{{constant::$search_base_url }}q={{$query}}&p_num=1&s_type=news" class="{{$s_type['news']}} sb_detail-header__catagories sb_detail-header__catagories--margin-left disable-highlight">News</a></span>
