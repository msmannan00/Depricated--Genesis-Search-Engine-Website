        ...
        <div class="ab_result">
            <div class="ab_result__container">
                <article class="markdown-body entry-content" itemprop="text">
                    ...
                    <ul>
                        <li class="ab_result__list-item">Boogle Search has two primary goals</li>
                    ...
                    <ul>
                        ...
                        <li class="ab_result__list-item">Multiple filed searching</li>
                        <li class="ab_result__list-item">Multiple field sorting</li>
                        <li class="ab_result__list-item">Multiple field filtering</li>
                        <li class="ab_result__list-item">Multiple field grouping</li>
                        <li class="ab_result__list-item">Support various dbms daab importing</li>
